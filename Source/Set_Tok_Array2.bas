Attribute VB_Name = "Set_Tok_Array"
Option Explicit
'-------------------------------
...
Public Const TK_struint = 24    'was 5 from .t
Public Const TK_dwordfloat = 25 'was 8 from .t
Public Const TK_buffer = 26     'was 9 from .t
Public Const TK_somefloat = 27  'was 10 from .t
...
Public TokenType As Long
Public TokenCount As Long
Public TokenPrecis As Long
Public TokenEmbed As Boolean

'Public Tokens As New colTok

Public Sub Init_Tokens()
...
Private Sub Init_T()
    ...
    Call Set_Entry(T_Type, 251, "terrain_water_height_offset", 1, 0, TK_somefloat, 4, 3)
...
Private Sub Set_Entry(kind As Long, p1 As Long, p2 As String, p3 As Long, p4 As Long, p5 As Long, p6 As Long, p7 As Long)
    ...
    Tokens.Add LCase(p2), p1, p5, CBool(p4), p6, p7, CStr(kind) & "_" & CStr(p1)
